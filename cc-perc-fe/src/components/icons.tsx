...
export const GlobeIcon = ({ size = 24, width, height, ...props }: IconSvgProps) => (
  ...
  >
    ...
    />
    <path
      d="M2 12h20M12 2c2.761 3.630 2.761 14.37 0 18M12 2c-2.761 3.630-2.761 14.37 0 18"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const CodeIcon = ({ size = 24, width, height, ...props }: IconSvgProps) => (
  <svg
    aria-hidden="true"
    fill="none"
    focusable="false"
...
export const ImageIcon = ({ size = 24, width, height, ...props }: IconSvgProps) => (
  <svg
    aria-hidden="true"
    fill="none"
    focusable="false"
...
export const ExclamationIcon = ({ size = 24, width, height, ...props }: IconSvgProps) => (
  <svg
    aria-hidden="true"
    fill="none"
    focusable="false"
...
export const ClockIcon = ({ size = 24, width, height, ...props }: IconSvgProps) => (
  <svg
    aria-hidden="true"
    fill="none"
    focusable="false"
